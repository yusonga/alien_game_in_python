...
class AlienInvasion:
	...
	def __init__(self):
		...
		#now we changed to run game in fullscreen
	...
	def _check_events(self):
		...
		for event in pygame.event.get():
				if event.type == pygame.QUIT:
					#when click game window's clos button,
				#a pygame.QUIT event is detected and we call 
				#sysexit to exit the game.
					sys.exit()
...
#make the most recently drawn screen visible
		    #erase the lod screen so only the new screen is visible
		pygame.display.flip()
